    ...
    <div>
      ...
      <div className="home-container">
          ...
          <div className="section intro-section">
            ...
            {/* Left Side Image with Clickable Top-Right Corner */}
            {animateStar && <div className="dim-overlay"></div>}

            {!starClicked && !animateStar && (

              <div className="hidden-star">
                <span className="filled-star" onClick={handleStarClick}>⭐</span>
                </div>
                )}

                
                {animateStar && (
                  <span className="animate-to-center">⭐</span>
                )}

              

              <div className="frame-face-container">
                
              <img
                src="/Frame+Face 2.png"
                alt="Frame & Face"
                className={`frame-face ${hasDropped ? 'fall-to-15' : ''}`}
              />
              <div className="corner-click-area" onClick={handleRotate}></div>
            </div>
